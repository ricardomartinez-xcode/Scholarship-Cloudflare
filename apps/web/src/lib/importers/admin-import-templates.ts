...
export const ADMIN_IMPORT_TEMPLATES = [
  ...
  },
  {
    ...
    rows: [
      ["C1", "Hermosillo", "Administracion de Empresas", "licenciatura", "presencial", "9", "M1", "L-V 08:00-13:00", "", "", "true", "3 materias"],
      ["C1", "Los Cabos", "Derecho", "licenciatura", "mixta", "9", "M2", "", "L-V 08:00-13:00", "Sáb 09:00-14:00", "true", "4 materias"],
      ["C1", "Online", "Psicologia", "licenciatura", "online", "9", "Longitudinal", "Online asincrónico", "", "", "true", "Flexible"],
    ],
    notes: [
