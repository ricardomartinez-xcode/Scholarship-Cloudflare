...
export const ADMIN_IMPORT_TEMPLATES = [
  ...
  },
  {
    ...
    description: "Plantilla de referencia para preparar la oferta académica antes de exportarla a Excel.",
    moduleLabel: "Oferta académica",
    format: "csv",
    fileName: "plantilla-oferta-academica-referencia.csv",
    headers: ["ciclo", "plantel", "programa", "nivel", "modalidad", "plan", "activo", "notas"],
    rows: [
      ["C1", "Hermosillo", "Administracion de Empresas", "licenciatura", "presencial", "2024", "true", "Referencia"],
      ["C1", "Online", "Psicologia", "licenciatura", "online", "2024", "true", "Referencia"],
    ],
    notes: [
      "El importador actual de oferta académica consume Excel; esta plantilla sirve como referencia operativa de columnas esperadas.",
      "Convierte o adapta estos datos al formato XLSX oficial antes de cargar oferta académica.",
    ],
  },
