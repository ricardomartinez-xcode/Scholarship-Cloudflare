...
export const workspaceLegacyQueryRedirects: Record<string, string> = {
  ...
  sesiones: "/unidep/capacitacion/sesiones",
...
export const dashboardTitles: Record<string, string> = {
  ...
  "/unidep/capacitacion/sesiones": "Sesiones",
...
export function resolveDashboardBreadcrumbs(pathname: string): string[] {
  if (pathname.startsWith("/admin")) {
    return ["Admin", resolveDashboardTitle(pathname)];
  }

  if (pathname.startsWith("/unidep")) {
    return ["UNIDEP", resolveDashboardTitle(pathname)];
  }
