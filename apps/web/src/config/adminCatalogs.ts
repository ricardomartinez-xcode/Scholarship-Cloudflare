export const CTA_LOCATIONS = [
  ...
  },
  {
    ...
    label: "App UNIDEP — debajo del resultado",
    description: "Se muestra debajo del panel de resultado de la calculadora en la app autenticada (/unidep).",
  },
  {
    value: "APP_RESULTS_ABOVE",
    label: "App UNIDEP — arriba del resultado",
    description: "Se muestra justo antes del panel de resultado de la calculadora en /unidep.",
  },
  {
    value: "APP_RESULTS_INSIDE",
    label: "App UNIDEP — acciones complementarias del workspace",
    description: "Se muestra junto con las acciones del workspace debajo de Explorar UNIDEP.",
  },
  {
    value: "UNIDEP_PRIMARY",
    label: "App UNIDEP — barra superior del workspace",
    description: "Se muestra junto a Workspace, Agenda, Historial y accesos rápidos del workspace.",
  },
  {
  ...
  {
    value: "AUTH_WELCOME",
    label: "App UNIDEP — bienvenida post-login",
    description: "Banner de bienvenida que se muestra tras iniciar sesión.",
  },
  {
    value: "AUTH_WELCOME_INSIDE",
    label: "App UNIDEP — dentro del panel de bienvenida",
    description: "Se muestra dentro del bloque de bienvenida posterior al login, para sumar acciones contextuales.",
  },
  {
...
export const CTA_LOCATION_META = {
  ...
  APP_RESULTS_INSIDE: {
    pageKey: "app",
    pageLabel: "App UNIDEP",
    sectionLabel: "Sidebar operativa",
    slotLabel: "Acciones complementarias",
    shortLabel: "Acciones extra",
  },
  APP_RESULTS_BELOW: {
    pageKey: "app",
    pageLabel: "App UNIDEP",
  ...
  UNIDEP_PRIMARY: {
    pageKey: "app",
    pageLabel: "App UNIDEP",
    sectionLabel: "Barra superior",
    slotLabel: "Workspace y accesos",
    shortLabel: "Barra superior",
  },
  CALCULATOR_FOOTER: {
    pageKey: "app",
    pageLabel: "App UNIDEP",
  ...
  AUTH_WELCOME: {
    pageKey: "app",
    pageLabel: "App UNIDEP",
    sectionLabel: "Bienvenida post-login",
    slotLabel: "Banner principal",
  ...
  AUTH_WELCOME_INSIDE: {
    ...
    pageLabel: "App UNIDEP",
    sectionLabel: "Bienvenida post-login",
    slotLabel: "Dentro del panel",
    shortLabel: "Dentro bienvenida",
  },
  ADMIN_HEADER_BANNER: {
    pageKey: "admin",
    pageLabel: "Admin",
