...
ensureDatabaseUrl();
const createPrismaClient = () => new PrismaClient({ log: process.env.NODE_ENV === "development" ? ["error", "warn"] : ["error"] });
declare global { var __releadPrisma: PrismaClient | undefined; }
