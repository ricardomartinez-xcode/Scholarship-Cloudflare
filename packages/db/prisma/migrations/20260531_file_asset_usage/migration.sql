CREATE TABLE IF NOT EXISTS "recalc_admin"."file_asset" (
  ...
  "uploaded_by_user_id" UUID REFERENCES "recalc_admin"."user"("id") ON DELETE SET NULL,
  "created_at" TIMESTAMPTZ NOT NULL DEFAULT now(),
  "updated_at" TIMESTAMPTZ NOT NULL DEFAULT now()
);

CREATE INDEX IF NOT EXISTS "file_asset_mime_type_idx"
ON "recalc_admin"."file_asset"("mime_type");

CREATE INDEX IF NOT EXISTS "file_asset_created_at_idx"
ON "recalc_admin"."file_asset"("created_at" DESC);
